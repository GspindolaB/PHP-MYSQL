        ...
        <div class="row justify-content-center mt-5">
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" name="password2" id="password2" placeholder="Repite Contraseña:" class="form-control">
                    <div class="input-group-append">
                ...
                <p class="text-center text-white">¿Ya tienes una cuenta?</p>
                <p class="text-center"><a href="login.php">Iniciar Sesión</a></p>
            </div>
        </div>
    </div>
